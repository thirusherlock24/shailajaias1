...
const Page3 = () => {
  ...
  return (
    <div className="page-3" style={{ minHeight: '130vh', backgroundColor: 'lightblue', overflowX: 'hidden' }}>
        <div className="move">
      <div className="header3">
        <h1 className="title3">
          <span style={{ color: '#ce5e11' }}>Mains Test Series
</span> 
        </h1>
      </div>
...
<br/><br/>Total Mains Marks Coverage: ~ 470
