...
const Landingpage = () => {
  return (
    <header className="h-[16.6666vh] flex flex-column md:flex justify-between items-center p-2.5 bg-blue-200 text-white relative">
      <div className="flex items-center">
        ...
        <div className="logo-container flex justify-center items-center">
          <img src={symbol} alt="logo" className="max-h-[20%] max-w-[20%] " />
        </div>
      </div>
