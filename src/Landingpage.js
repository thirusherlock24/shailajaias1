    ...
    <header className="h-[16.6666vh] flex flex-column md:flex justify-between items-center p-2.5 bg-blue-200 text-white">
      ...
      <div className="contact-details flex flex-col items-end text-black mt-4 md:mt-0 whitespace-nowrap md:flex-1 md:justify-end">
        <div className="flex items-center space-x-2">
          ...
          <a href="tel:9900691648" className="hover:underline"><span className='md:text-xl' >9900 691 648</span></a>
        </div>
        <div className="hidden md:flex items-center space-x-2 whitespace-nowrap">
          <i className="fas fa-envelope"></i>
          <a href="mailto:gvg@shailajaias.com" className="hover:underline"><span className='md:text-xl' >gvg@shailajaias.com</span></a>
        </div>
        <div className="flex items-center space-x-2 whitespace-nowrap">
          <i className="fab fa-telegram"></i>
          <a href="https://t.me/shailajaias" target="_blank" rel="noopener noreferrer" className="hover:underline"><span className='md:text-xl' >t.me/shailajaias</span></a>
        </div>
      </div>
    </header>
  );
